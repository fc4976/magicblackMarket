    ...
    public class MessageBoxService
    {
            ...
            List<string> customLabels)
        {
            ...
            if (null != rootVisual)
            {
                ...
                TextBlock message = new TextBlock
                {
                    ...
                    Height = 0.236 * Application.Current.RootVisual.RenderSize.Width
                };
                container.Children.Add(message);
                Image img = new Image();
                Uri uri = new Uri("images/Hogwarts.jpg", UriKind.Relative);
                ...
                img.Opacity = 0.5;
                //+Fu Cong
                //this._mbsRoot.Children.Add(img);
                //-Fu Cong
                ...
                switch (button)
                {
                    case MessageBoxServiceButton.OK:
                        this.CreateOKButton(
                            null == customLabels ? "OK" : customLabels[0],
                            2);
                        container.SetValue(Grid.ColumnSpanProperty, 2);
                        break;
                    case MessageBoxServiceButton.OKCancel:
                        ...
                        this.CreateCancelButton(
                            null == customLabels ? "Cancel" : customLabels[1],
                            1);
                        break;
                    case MessageBoxServiceButton.YesNoCancel:
                        ...
                        this.CreateYesButton(
                            null == customLabels ? "Yes" : customLabels[0]);
                        this.CreateNoButton(
                            null == customLabels ? "No" : customLabels[1],
                            3);
                        this.CreateCancelButton(
                            null == customLabels ? "Cancel" : customLabels[2],
                            2);
                        break;
                ...
                foreach (var timeline in _showStoryboard.Children)
                {
        ...
        private void CreateOKButton(string label, int columnSpan = -1)
        {
            Button ok = new Button
            {
                ...
                Opacity= 0,
                Style = Application.Current.Resources["PressNoWhiteButton"] as Style
            };
            ok.Click += this.OnOK;
            ok.SetValue(Grid.RowSpanProperty, 2);
            ...
            if (columnSpan > -1)
            {
                ok.Margin = new Thickness(12, 0, 50, 12);
